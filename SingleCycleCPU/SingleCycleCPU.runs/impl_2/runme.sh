...
HD_PWD='E:/ComputerLogicDesign/MIPS/SingleCycleCPU/SingleCycleCPU.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log SingleCycleCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SingleCycleCPU.tcl -notrace
